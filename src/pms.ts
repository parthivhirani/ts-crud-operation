...
let arrid: number[] = JSON.parse(localStorage.getItem('PID')!);
let arrname: string[] = JSON.parse(localStorage.getItem('PNAME')!);
let arrcategory: string[] = JSON.parse(localStorage.getItem('PCATEGORY')!);
let arrimage: string[] = JSON.parse(localStorage.getItem('PIMAGE')!);
let arrprice: number[] = JSON.parse(localStorage.getItem('PPRICE')!);
let arrdesc: string[] = JSON.parse(localStorage.getItem('PDESC')!);
let arrmode: string[] = JSON.parse(localStorage.getItem('PMODE')!);
// localStorage.clear();

// viewData();
let img2: any = document.getElementById('pimage');
...
function clsModal() {
    (<HTMLFormElement>document.getElementById("product-form"))!.reset();
    (<HTMLFormElement>document.getElementById("remChar"))!.innerHTML = '';
}
...
function validate() {
    ...
    let pcategory = document.getElementById('pcategory') as HTMLSelectElement;
    let pimage = base64;
    let pprice = document.getElementById('pprice') as HTMLInputElement;
    let pdesc = document.getElementById('pdesc') as HTMLSelectElement;
    let ppayment = document.querySelector('payment') as HTMLInputElement;
...
function addData() {
    ...
    let pid = document.getElementById('pid') as HTMLInputElement;
    let pname = document.getElementById('pname') as HTMLInputElement;
    let pcategory = document.getElementById('pcategory') as HTMLInputElement;
    let pimage = base64;
    let pprice = document.getElementById('pprice') as HTMLInputElement;
    let pdesc = document.getElementById('pdesc') as HTMLInputElement;
    let pmode = document.querySelector('input[name="payment"]:checked') as HTMLInputElement;
    ...
    if(validate()) {
        if(ids=='x') {
            ...
            arrid[ids] = (pid.value as unknown) as number;
            arrname[ids] = pname.value;
            arrimage[ids] = pimage;
            arrprice[ids] = (pprice.value as unknown) as number;
        ...
        location.href = ('productRecords.html');
...
function editData(delid: number) {

    ids = delid;
    console.log(delid);
    base64 = arrimage[delid];
    (<any>document.getElementById('pid')).value  = arrid[delid];
    (<any>document.getElementById('pname')).value = arrname[delid];
    (<HTMLSelectElement>document.getElementById('pcategory')).value = arrcategory[delid];
    (<any>document.getElementById('pprice')).value = arrprice[delid];
    document.getElementById('pdesc')!.innerHTML = arrdesc[delid];
    (<HTMLInputElement>document.querySelector(`input[value="${arrmode[delid]}"]`)).checked = true;
}

function deleteData(delid: number) {
...
function filterProducts(y: string) {
